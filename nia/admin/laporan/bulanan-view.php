                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <?php echo " <a href='print.php?t=$_POST[t]&b=$_POST[b]' class='btn btn-primary'>PRINT</a>"; ?>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $queri = "SELECT * FROM laporan where   month(tgl_laporan)='$_POST[b]' AND year(tgl_laporan)='$_POST[t]'";
